...
public class PhonePreferences extends PreferenceActivity {

    private static final String TAG = "PhonePreferences ";

    private RingtonePref mRingtone;

    private VolumePref mRingVolume;

    CheckBoxPreference  mLed, mRinger, mVibrate;

    ListPreference  mLedPattern, mLedColor, mVibratePattern;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( mLed == null || mRinger == null || mVibrate == null
                || mRingtone == null || mRingVolume == null || mLedPattern == null || mLedColor == null || mVibratePattern == null) {
            if (Log.LOGV)
                Log.e(TAG
    ...
    private void setParcelData() {
        ...
        try {
            pNotify.notify_active = false;
            pNotify.notify_icon = "notused";
